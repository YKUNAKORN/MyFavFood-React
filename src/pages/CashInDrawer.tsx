...
import '../styles/cash-in-drawer.css';

const CashInDrawer: React.FC = () => {
    return (
            ...
            <div className="r-sidebar">
                ...
                <header>
                    <div className="nav-current">
                        ...
                        <p className="nav">&gt;</p>
                        <p className="nav-active">Cash in drawer</p>
                    </div>
                ...
                <div className="container">
                    ...
                    <div className="tab-container">
                        <a href="../pages/start-day.html">
                            <p>Start Day</p>
                        </a>
                        <a href="../pages/cash-in-drawer.html">
                            <p>Cash in drawer</p>
                        </a>
                        <a href="../pages/end-day.html">
                            <p>End day</p>
                        </a>
                        <span></span>
                    </div>
                    ...
                    <div className="form-container" id="start-day">
                        <form id="dayForm">
                            ...
                            <div className="input-group column1">
                                ...
                                <p>Salad</p>
                                <label htmlFor="text">
                                    <input type="text" id="BREAD_IN2" placeholder="Not available" disabled />
                                    <i className="bi bi-123"></i>
                                </label>

                                <p>Other</p>
                                <label htmlFor="text">
                                    <input type="text" id="BREAD_IN3" placeholder="Not available" disabled />
                                    <i className="bi bi-123"></i>
                                </label>
                            </div>
                        </form>
