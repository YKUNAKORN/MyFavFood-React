...
import '../styles/ring-sales.css';

const RingSales: React.FC = () => {
    return (
        <div className="main-content">
            ...
            <div className="l-sidebar">
                ...
                <nav>
                    ...
                    <a href="/ring-sales" className="active"><i className="bi bi-graph-up"></i> Ring Sales</a>
            ...
            <div className="r-sidebar">
                <header>
                    <div className="nav-current">
                        ...
                        <p className="nav">{'>'}</p>
                        <p className="nav-active">Ring Sales</p>
                    </div>
                ...
                <section className="main-container">
                    ...
                    <div className="actions">
                       <div className="controls">
                        ...
                        {/* Add id to input for easier management */}
                        <div id="item-list" className="display">
                        ...
                        <div className="checkout">
                            ...
                            <div className="column2-btn">
                                <button className="total-btn">Total<i className="bi bi-coin"></i></button>
