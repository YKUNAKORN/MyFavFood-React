            ...
            <div className="r-sidebar">
                ...
                <header>
                    <div className="nav-current">
                        ...
                        <p className="nav">{'>'}</p>
                        <p className="nav-active">Start Day</p>
                    </div>
                    ...
                    <div className="form-container" id="start-day">
                        <form id="dayForm">
                            ...
                            <div className="input-group column1">
                                <p>Drawer cash</p>
                                <label htmlFor="drawer-cash-number">
                                    <input type="number" id="drawer-cash-number" placeholder="0.00" />
                                    <i className="bi bi-currency-bitcoin"></i>
                                </label>

                                <p>Coin</p>
                                <label htmlFor="coin-number">
                                    <input type="number" id="coin-number" placeholder="0.00" />
                                    <i className="bi bi-currency-bitcoin"></i>
                                </label>

                                <p>Safe</p>
                                <label htmlFor="safe-number">
                                    <input type="number" id="safe-number" placeholder="0.00" />
                                    <i className="bi bi-currency-bitcoin"></i>
                                </label>
                            </div>
                            ...
                            <div className="input-group column1">
                                <p>Bread In</p>
                                <label htmlFor="bread-in-number">
                                    <input type="number" id="bread-in-number" placeholder="0" />
                                    <i className="bi bi-123"></i>
                                </label>

                                <p>Salad</p>
                                <label htmlFor="salad-text">
                                    <input type="text" id="salad-text" placeholder="Not available" disabled />
                                    <i className="bi bi-123"></i>
                                </label>

                                <p>Other</p>
                                <label htmlFor="other-text">
                                    <input type="text" id="other-text" placeholder="Not available" disabled />
                                    <i className="bi bi-123"></i>
                                </label>
                            </div>
                        </form>
