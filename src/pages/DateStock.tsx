                    ...
                    <div className="container2">
                        <div className="table-container2">
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        <td>Monday, 14 July 2024</td>           <td>09 : 17 : 45</td>       <td><a href="/stock"><button className="continue-btn">Continue <i className="bi bi-caret-right"></i></button></a></td>
                                    </tr>
                                    <tr>
                                        <td>Thurday, 4 July 2024</td>           <td>12 : 30 : 00</td>       <td><a href="/stock"><button className="continue-btn">Continue <i className="bi bi-caret-right"></i></button></a></td>
                                    </tr>
                                    <tr>
                                        <td>Tuesday, 22 November 2024</td>      <td>12 : 30 : 55</td>       <td><a href="/stock"><button className="continue-btn">Continue <i className="bi bi-caret-right"></i></button></a></td>
                                    </tr>
                                    <tr>
                                        <td>Friday, 20 July 2024</td>           <td>03 : 56 : 15</td>       <td><a href="/stock"><button className="continue-btn">Continue <i className="bi bi-caret-right"></i></button></a></td>
                                    </tr>
                                    <tr>
                                        <td>Saturday, 1 Januarry 2024</td>      <td>08 : 00 : 00</td>       <td><a href="/stock"><button className="continue-btn">Continue <i className="bi bi-caret-right"></i></button></a></td>
                                    </tr>
